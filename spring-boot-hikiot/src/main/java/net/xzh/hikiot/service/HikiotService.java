...
public class HikiotService {
    ...
    public String getUserAccessToken() {
        ...
        Map<String, Object> data = getHikvisionDataByGet(API_CODE2_TOKEN_URL, appToken, null, params, true);
    ...
    public Map<String, Object> getResourcesData(String deviceSerial, String channelNo) {
        ...
        Map<String, Object> data = getHikvisionDataByGet(API_RESOURCE_URL, appToken, userToken, params, true);
    ...
    public Map<String, Object> getTokensData(String deviceSerial, Integer channelNo) {
        ...
        Map<String, Object> data = getHikvisionDataPost(API_BATCH_DEVICE_TOKEN_URL, appToken, userToken, requestBody, true);
    ...
    public Map<String, Object> getCapacitysData(String deviceSerial, String channelNo) {
        ...
        Map<String, Object> data = getHikvisionDataByGet(API_DEVICE_CAPACITIES_URL, appToken, userToken, params, true);
    ...
    public Map<String, Object> getEzvizData() {
        ...
        Map<String, Object> data = getHikvisionDataByGet(API_OPS_TOKEN_URL, appToken, userToken, null, true);

        logger.info("结束获取非设备token EzvizData: {} ", data);
        return data;
    }

    public Map<String, Object> refreshAppToken(String appAccessToken, String refreshAppToken) {
    ...
    public Map<String, Object> refreshUserToken(String appAccessToken, String userAccessToken, String refreshUserToken) {
        logger.info("开始刷新用户访问凭证");

        Map<String, Object> requestBody = new HashMap<>();
        requestBody.put("userAccessToken", userAccessToken);
        requestBody.put("refreshUserToken", refreshUserToken);

        Map<String, Object> data = getHikvisionDataPost(API_REFRESH_USER_TOKEN_URL, appAccessToken, null, requestBody, true);
